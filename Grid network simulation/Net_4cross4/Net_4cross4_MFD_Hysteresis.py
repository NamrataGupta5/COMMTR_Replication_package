...
BaseDir = os.path.normpath(values['-ID2-'])
                    #----------Input in Vissim--
EpDur,SimRes,RandNo,Repeat,EvalFromTm,EvalInter,CycTm=int(2*3600),3,42,5,0,60,60
...
ExLinks_st = np.array([26,26,23,36,
                       24,24,29,32,
                       25,25,27,31,
                       38,38,45,42,
                       15,15,44,46,
...
ExLinks_TR = np.array([23,36,26,26,
                       29,32,24,24,
                       27,31,25,25,
                       45,42,38,38,
                       44,46,15,15,
...
# SHdf['ReEntryLinks'] = ReEntryLinks
SC= np.array([])
for i in range(1,17):
